...
<html>
    ...
    <body>
        <div style="color:white; margin: auto; height: 500px; width: 500px; margin-top:50px;">
        <h1 style="font-size: 36px; color:white; text-align:center; margin: 0 auto;">Admin Login</h1>
        <p></p>
